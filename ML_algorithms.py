...
## =====================================================================================================================
## ------------------------------------------------------------------------------------------------------------------- #
##                                         hybridMLAlgorithm function                                                  #
## ------------------------------------------------------------------------------------------------------------------- #
##              Description: This function creates and trains a hybrid machine learning algorithm that                 #
##                           performs simultaneously both regression and classification. Currently it                  #
##                           is implemented to work with predefined by the user parameters and does not                #
##                           optimize the algorithm parameters. For regression a MLPRegressor is used or               #
##                           a keras NN. For the classification random forest classifier is being used                 #
##                           since it supports multi-output multi-class classification. 10-fold cross                  #
##                           validation is used and the evaluation metrics are the hypervolume difference              #
##                           and the neighborhood f1 score for the regression and classification respectively.         #
## =====================================================================================================================
...
##                                              kerasNN function                                                       #
## ------------------------------------------------------------------------------------------------------------------- #
##              Description: This function creates and trains a keras Neural Network based on given input              #
##                           and target and returns the results. It can be run with fixed parameters or it             #
##                           optimizes nn's parameters by doing a 10-fold cross validation grid search given           #
##                           a set of parameters by the user. Parameters that can be optimized include                 #
##                           1) number of hidden layers, 2) number of hidden neurons, 3) optimizer,                    #
##                           4) activation function and 5) dropout                                                     #
##                           The history of the keras nn is stored for observing the learning process in               #
##                           a later step.                                                                             #
## =====================================================================================================================
...
## ------------------------------------------------------------------------------------------------------------------- #
##              Description: This function creates the necessary keras model for the kerasNN function.                 #
##                           It can support different number of hidden layers, different number of hidden neurons,     #
##                           different activation functions, different dropout and various optimizers.                 #
## =====================================================================================================================
...
# def create_keras_model(inputShape= 6, outputShape= 20, optimizer='adam', activation='sigmoid', hidden_layers=1, neurons=5):
    ...
    model.compile(loss = hyperVolumeIndex_keras_loss_func, optimizer=optimizer, metrics = ['mse'])
