...
## =====================================================================================================================
## ------------------------------------------------------------------------------------------------------------------- #
##                             hypervolume difference index metric (keras)                                             #
## ------------------------------------------------------------------------------------------------------------------- #
##          Description: This is a symbolic keras function that calculates the hypervolume difference metric           #
##                       introduced in https://link.springer.com/chapter/10.1007/978-3-642-30976-2_61                  #
##                       More specifically it calculates the area between the target pareto front                      #
##                       and the one derived as output from a ML algorithm. This is done by specifying                 #
##                       a reference point.                                                                            #
## =====================================================================================================================
...
def hyperVolumeIndex_keras_loss_func(y_true, y_pred):
    ...
    hv_k = K.placeholder(dtype = 'float32')

    hv_k_loss = K.function([y_true, y_pred], [hpv_index], [hyperVolumeIndex_loss_func(y_true, y_pred)])
